...
import com.ars.air.service_imple.AdminServiceImple;
import com.ars.air.service_imple.AirlineServiceImpl;
import com.ars.air.service_imple.FlightServiceImpl;
import com.ars.air.service_imple.PassengerServiceImple;
import com.ars.air.service_imple.TicketServiceImple;


public class CrudOperation {
	static AdminService aservice=new AdminServiceImple();
	static PassengerService pservice=new PassengerServiceImple();
	static FlightService fService=new FlightServiceImpl();
	static AirlineService aService=new AirlineServiceImpl();
	static TicketService tService=new TicketServiceImple();
